...
class MockOpenDataConnectorTest extends OpenDataConnectorTemplateTest {

    @Mock
    private MockOpenDataRestClient restClientMock;

    @InjectMocks
    private MockOpenDataConnector openDataConnector;
