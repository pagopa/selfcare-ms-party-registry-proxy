...
class StationIndexWriterFactoryTest {

    @Autowired
    private Directory anacDirectory;

    @Autowired
    private StationIndexWriterFactory indexWriterFactory;
    ...
    void create() {
        ...
        assertSame(anacDirectory, indexWriter.getDirectory());
    ...
    void create_Exception() {
        // given
        final IndexWriterFactory indexWriterFactory = new StationIndexWriterFactory(null, new StationTokenAnalyzer());
        // when
