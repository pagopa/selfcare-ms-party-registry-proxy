...
@Slf4j
public class InstitutionFSIndexSearchService implements IndexSearchService<Institution> {
    ...
    @SneakyThrows  //TODO
    @Autowired
    public InstitutionFSIndexSearchService(InstitutionTokenAnalyzer institutionTokenAnalyzer, Directory directory) {
